...
app = Flask(__name__)
app.secret_key = 'superrandomstringofcharacters'
...
def get_startActor():   
    request=get_popular("8b644cf36c1cdfe878910278f2fe06cb")
    ...
    anotherActor=get_info(movie, "8b644cf36c1cdfe878910278f2fe06cb", STEP1ACTOR ) #RETURN TYPE IS AN ARRAY 
    ...
    anotherActor=get_info(SECONDMovie, "8b644cf36c1cdfe878910278f2fe06cb", STEP2ACTOR)
    ...
    anotherActor=get_info(THIRDMovie, "8b644cf36c1cdfe878910278f2fe06cb", STEP3ACTOR)
...
def getComparison(movie, start, end, goal):
    api_request=get_id(movie, "8b644cf36c1cdfe878910278f2fe06cb")
    api_request=get_json(api_request)
    #print(api_request)
    ...
    if len(api_request['results']) > 0:
        ...
        return 0
    cast=get_cast(movie_id, "8b644cf36c1cdfe878910278f2fe06cb" )
    cast=get_json(cast)
    #print(cast)
